            ...
            <x-card>
                ...
                <x-card-body>
                    <form action="{{ route('projects.store') }}">
                        ...
                        <input class="form-control" type="number" id="user_id" name="user_id"><br>
                        <label for="is_active" class="mb-1">Активность</label><br>
                        <input class="form-control" type="text" id="is_active" name="is_active"><br>
                        <label for="is_active" class="mb-1">Ответственный</label><br>
                        <input class="form-control" type="number" id="assignee_id" name="assignee_id"><br>
                        <label for="deadline_date" class="mb-1">Дэдлайн</label><br>
                        <input class="form-control" type="number" id="deadline_date" name="deadline_date"><br><br>
